...
$BB0_5:                                 #   Parent Loop BB0_2 Depth=1
	...
	br	$p1, $BB0_1
	nop
$BB0_13:                                #   in Loop: Header=BB0_5 Depth=2
	j	$BB0_4
	nop
$BB0_6:
	sw	$zero, 4($sp)
	j	$BB0_8
	nop
$BB0_7:                                 #   in Loop: Header=BB0_8 Depth=1
	lw	$1, 4($sp)
	addiu	$1, $1, 1
	sw	$1, 4($sp)
$BB0_8:                                 # =>This Loop Header: Depth=1
...
$BB0_10:                                #   in Loop: Header=BB0_11 Depth=2
	...
	addiu	$1, $1, 1
	sw	$1, 0($sp)
$BB0_11:                                #   Parent Loop BB0_8 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	lw	$1, 0($sp)
	cmpgti	$p1, $1, 4
	br	$p1, $BB0_7
	nop
$BB0_14:                                #   in Loop: Header=BB0_11 Depth=2
	j	$BB0_10
	nop
$BB0_12:
	lw	$4, 12($sp)
