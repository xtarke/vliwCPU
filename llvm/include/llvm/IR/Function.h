...
private:
  ...
  MachineFunction *MF;					  ///< Machine function utilized by Codegen
  void (*CGCleaner)(MachineFunction*);
...
public:
  ...
  void setMachineFunction(MachineFunction *mf) {MF = mf;}
  MachineFunction *getMachineFunction() {return MF;}
  void setCGCleaner(void (*func)(MachineFunction*)) {CGCleaner = func;}
