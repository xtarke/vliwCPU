...
class LLVM_LIBRARY_VISIBILITY NewTarget : public ToolChain {
  mutable llvm::DenseMap<unsigned, Tool*> Tools;

public:
  NewTarget(const Driver &D, const llvm::Triple& Triple);
  ...
  virtual bool IsIntegratedAssemblerDefault() const { return true; }
  virtual bool IsUnwindTablesDefault() const { return true; }
  virtual bool isPICDefault() const { return false; }
